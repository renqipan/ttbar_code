void fcp_plot(){
  ...
  l1->SetLineWidth(2);
  l1->SetLineColor(1);
  l1->DrawLine(-1.0,3.84,1.0,3.84);
  l1->Draw("same");
  c2->Print("./datacard/fcp_deltaNLL.png");
}